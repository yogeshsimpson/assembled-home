...
const footnotes: { tier: 'tier1' | 'tier2'; number: number; label: string; body: string }[] = [
  ...
  },
  {
    ...
    body: `Per the 03/13/26 formal SD estimate: double-stud structural wall panels with high-density natural fiber insulation. Two thickness options: R-58 at 16" thick or R-43 at 12" thick. Wall assembly includes service cavity (horizontal furring strips), variable-perm air barrier, diagonal sheathing, high-perm WRB, and a vented rain screen. New Frameworks publishes R-35 walls / R-50 roof for their standard straw-panel assembly — separately from Croft.`,
  },
  {
    tier: 'tier1',
    number: 4,
    label: 'Croft roof R-value',
    body: `The formal SD estimate explicitly says "R-Value dependent on specified assembly." Croft doesn't pin a roof number without seeing the final design. Assembly assumes Croft's standard roof system; adjustments may be needed after structural engineering. The roof panel scope includes ceiling strapping for electrical, variable-perm air barrier, WRB, vented channel, and sheathing with metal-roofing-approved underlayment.`,
  },
  {
    tier: 'tier1',
    number: 5,
  ...
  },
  {
    tier: 'tier1',
    number: 7,
    label: 'Stillwater scopes',
    body: `The $155K is the envelope-only bid (walls, roof, insulation, air sealing, partitions, stairs). The $400K is the full GC quote from site prep through drywall — site work, foundation, roof, exterior trim and siding, plumbing and electrical rough-in, drywall. Not directly comparable to the panel envelope quotes — but the most complete number in the entire matrix.`,
  },
  {
    tier: 'tier2',
    number: 1,
